...
%% Next Steps
% 
% # Compute gain filters only at points where the stimulus is significantly away form the mean
...
% # Use filtfilt instead of filter to filter signals
% # Filter ORN firing rates with a 30ms box to remove wiggles that are just noise
