...
% this variant includes an additional timescale.
% testing this. 
%
...
function [R,y,z,Ky,Kz] = DAModelv4(S,p)
...
filter_length = 4*max([p.n_z*p.tau_z  p.n_y*p.tau_y p.n_z2*p.tau_z2]);
...
Kz2 = generate_simple_filter(p.tau_z2,p.n_z2,t);
