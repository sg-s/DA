...
% here we throw away tau_r as we never use it and instead introduce a new parameter, r0, which is a constant that is subtracted from the stimulus before the rest of the DA model acts on this.
...
y = filter(Ky,1,S-p.r0);
z = filter(Kz,1,S-p.r0);
