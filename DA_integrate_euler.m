% an attempt to not use interp1 to make this function faster to evaluate
% since the problem is that we have values of zt and yt only at fixed time points, let's
% simply use a euler method at those fixed time steps to integrate the equation
function R = DA_integrate_euler(S,p)
...
% integrate DA equation using a first order euler method
