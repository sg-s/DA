% MinL1Solution.m
% finds the solution that minimises l1 norm
% 
% adapted form:
% l1eq_pd.m
%
...
function xp = MinL1Solution(x0, A, b, pdtol, pdmaxiter, cgtol, cgmaxiter)
...
% defaults
if (nargin < 4), pdtol = 1e-3;  end
if (nargin < 5), pdmaxiter = 50;  end
if (nargin < 6), cgtol = 1e-8;  end
if (nargin < 7), cgmaxiter = 200;  end
