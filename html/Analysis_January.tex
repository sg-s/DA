...
\setlength{\itemsep}{-1ex}
   ...
   \item Estimating the gain at points where the stimulus is far from the mean.
...
\end{par} \vspace{1em}
        ...
        \color{lightgray} \begin{verbatim}    0.9393
...
\includegraphics [width=\textwidth]{Analysis_January_26.pdf}
\begin{par}
The r-square of the smoothed ORN response to the actual data is
\end{par} \vspace{1em}

        \color{lightgray} \begin{verbatim}    0.9714
...
\end{par} \vspace{1em}
        ...
        \color{lightgray} \begin{verbatim}    0.9663

\end{verbatim} \color{black}
    \begin{par}
Does the smoothing operation interfere with the gain modulation we observe?
\end{par} \vspace{1em}

\includegraphics [width=\textwidth]{Analysis_January_27.pdf}

\includegraphics [width=\textwidth]{Analysis_January_28.pdf}


\subsection*{Estimating the gain at points where the stimulus is far from the mean.}
...
\setlength{\itemsep}{-1ex}
   ...
   \item Compute ORN firing rates using code that is not Carlotta's
\end{enumerate}
