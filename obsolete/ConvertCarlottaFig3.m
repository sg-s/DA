...
% filepath = ('/local-data/DA-paper/carlotta-martelli/fig3/data_2011_10_04_2ac_dr_N12.mat');
...
% save('/local-data/DA-paper/carlotta-martelli/fig3/abc.mat','ControlParadigm','data','SamplingRate','OutputChannelNames')
