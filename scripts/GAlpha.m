...
[alldata(1).PID, alldata(1).LFP, alldata(1).fA, alldata(1).paradigm, alldata(1).orn, alldata(1).fly, alldata(1).AllControlParadigms, alldata(1).paradigm_hashes] = consolidateData('/local-data/DA-paper/g-alpha/rnai/uas-gal4/',true);
alldata(1).genotype = 'UAS-g-alpha-RNAi-22a-gal4';

[alldata(2).PID, alldata(2).LFP, alldata(2).fA, alldata(2).paradigm, alldata(2).orn, alldata(2).fly, alldata(2).AllControlParadigms, alldata(2).paradigm_hashes] = consolidateData('/local-data/DA-paper/g-alpha/rnai/uas-control/',true);
alldata(2).genotype = 'UAS-control';

[alldata(3).PID, alldata(3).LFP, alldata(3).fA, alldata(3).paradigm, alldata(3).orn, alldata(3).fly, alldata(3).AllControlParadigms, alldata(3).paradigm_hashes] = consolidateData('/local-data/DA-paper/g-alpha/rnai/gal4-control/',true);
