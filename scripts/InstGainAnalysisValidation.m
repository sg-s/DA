...
% In this section, we use a DA model to generate synthetic data. This model does have a dynamical gain control mechanism by construction. The following figure shows the response generated by the DA model, and the LN model backed out of this synthetic dataset. The parameters of the DA model are also shown below:
