...
function [p,low_slopes,high_slopes,low_gof,high_gof,example_plot,extra_variables,handles] = gainAnalysis(x,history_lengths,example_history_length,plothere,p)
