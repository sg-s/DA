figure out why loops--if LN model fits, there should be no loops. make an interactive Gain Anqt=ysis function that takes the data, and you can vary the histroy length, etc. 
